...
const DEMO_CLIENTS = [
  { id: 1,   name: 'Иван Иванов',     phone: '+7 925 123-45-67', tariff: 'standard',  level: 'premium',  visits: 42, totalSpent: 31500, points: 1280, pointsNext: 1500, avatarAsset: 'src/assets/avatars/avatar_1.jpeg' },
  { id: 2,   name: 'Алексей Кошкин',  phone: '+7 916 555-22-11', tariff: 'standard',  level: 'standard', visits: 18, totalSpent: 13500, points: 640, pointsNext: 1000, avatarAsset: 'src/assets/avatars/avatar_2.jpeg' },
  { id: 3,   name: 'Сергей Петров',   phone: '+7 903 777-44-33', tariff: 'standard',  level: 'premium',  visits: 55, totalSpent: 41250, points: 1410, pointsNext: 1500, avatarAsset: 'src/assets/avatars/avatar_3.jpeg' },
  { id: 4,   name: 'Нина Крюкова',    phone: '+7 912 666-33-44', tariff: 'pensioner', level: 'basic',    visits: 1,  totalSpent: 0,     points: 30,  pointsNext: 500,  avatarAsset: null },
  { id: 5,   name: 'Дмитрий Лагута',  phone: '+7 985 111-22-33', tariff: 'standard',  level: 'standard', visits: 21, totalSpent: 15750, points: 780, pointsNext: 1000, avatarAsset: 'src/assets/avatars/avatar_5.jpeg' },
  { id: 6,   name: 'Михаил Орлов',    phone: '+7 962 888-99-00', tariff: 'pensioner', level: 'premium',  visits: 68, totalSpent: 51000, points: 1500, pointsNext: 1500, avatarAsset: 'src/assets/avatars/avatar_6.jpeg' },
  { id: 7,   name: 'Олег Сидоров',    phone: '+7 905 222-77-66', tariff: 'standard',  level: 'basic',    visits: 7,  totalSpent: 5250,  points: 260, pointsNext: 500,  avatarAsset: 'src/assets/avatars/avatar_7.jpeg' },
  { id: 8,   name: 'Виктор Щукин',    phone: '+7 910 444-55-66', tariff: 'standard',  level: 'standard', visits: 14, totalSpent: 10500, points: 520, pointsNext: 1000, avatarAsset: 'src/assets/avatars/avatar_8.jpeg' },
  { id: 100, name: 'Уэйд Джереми',    phone: '+7 999 000-00-00', tariff: 'standard',  level: 'basic',    visits: 1,  totalSpent: 750,   points: 40, pointsNext: 500,  avatarAsset: 'src/assets/avatars/avatar_100.jpeg' },
];
