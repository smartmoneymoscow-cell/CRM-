...
///  13. Открывается ВСЕГДА, независимо от наличия места
///  14. Открывается ВСЕГДА под кнопкой, только вниз
///  15. При пересечении с нижним меню — меню ПЕРЕКРЫВАЕТ список (z-order)
///  16. Список НИКОГДА не сжимается и не меняет длину/форму
///  17. Список НИКОГДА не отрывается от низа кнопки и не двигается вверх
///
/// ┌─────────────────────────────────────────────────────────────────┐
