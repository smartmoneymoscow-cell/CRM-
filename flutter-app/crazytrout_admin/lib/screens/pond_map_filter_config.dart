...
///
/// Требование пользователя (цитата):
///   «При пересечении ли приближении к нижнему меню выпадающий список
///   категорически не должен сворачиваться или сжиматься, двигаться или
///   закрываться. Выпадающий список должен оставаться полностью неизменным
///   и скрываться под меню как и любая другая пролистываемая при скролле
///   часть страницы или контента, при обратном скролле раскрытый список
///   появляется из-под меню в неизменном состоянии.»
///
/// ┌─────────────────────────────────────────────────────────────────┐
